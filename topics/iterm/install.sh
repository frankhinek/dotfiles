...
# configured to use /Users/fhinek as the path prefix for the .dotfiles directory
# location.  The sed replaces "/Users/fhinek" with  the current user's $HOME
# directory before writing the result to com.googlecode.iterm2.plist.
sed "s;/Users/fhinek;$HOME;g" \
